                ...
                switch idx_string_found
                    ...
                    case 6 %% Abstract
                        ...
                        if isempty(idx_abstracttext_string)
                            ...
                            [Abstract, line] = getAbstract(xml,line,adj,adv,verb,noun);
                    ...
                    case 9 %% ArticleTitle
                        ...
                        [ArticleTitle, line] = getArticleTitle(xml,line,'<ArticleTitle','</ArticleTitle',adj,adv,verb,noun);
                    ...
                    case 10 %% CollectionTitle
                        ...
                        [ArticleTitle, line] = getArticleTitle(xml,line,'<CollectionTitle','<CollectionTitle',adj,adv,verb,noun);
...
statFileName = strcat(xmlfile(1:end-4),'-PubMed-v5.mat');
...
function [abstract, fileline] = getAbstract(pubmedfile,fileline,adj,adv,verb,noun)
    ...
    abstract = processParagraph(allAbstract,adj,adv,verb,noun);
...
function [articletitlekeywords, fileline] = getArticleTitle(pubmedfile,fileline,start_section,end_section,adj,adv,verb,noun)
    ...
    articletitlekeywords = processParagraph(articletitle,adj,adv,verb,noun);
...
function allkeywords = processParagraph(input_string,adj,adv,verb,noun)
