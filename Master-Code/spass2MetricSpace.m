function spass2MetricSpace(spassDataSetName,Conditions,inverter_movie)
...
for i=1:nConditions
    ...
    for k=1:nTrials
        ...
        if (i == 2) && (inverter_movie == 1)
            ...
            new_spikes = invertSpikeTrain(spikes,start_time,nBins,bin_size);
...
if (inverter_movie == 1)
    ...
    stawrite(X,strcat(registro,'-invertido'));
    
else
    
    stawrite(X,strcat(registro));
