...
for iROI=1:length(idx_ROI)
    ...
    load(strcat('All-Subjects','-','FC-Voxels-AAL-ROI','-','Track','-',area_label,'-','distribution-ZFisher','.mat'));
    load(strcat('All-Subjects','-','FC-Voxels-AAL-ROI','-','Passive','-',area_label,'-','distribution-ZFisher','.mat'));
    load(strcat('All-Subjects','-','FC-Voxels-AAL-ROI','-','RestingState','-',area_label,'-','distribution-ZFisher','.mat'));
