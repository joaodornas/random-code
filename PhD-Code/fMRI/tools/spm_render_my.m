function spm_render_my(dat,brt,rendfile,imgfile)
...
%         end
%     end
    surf_rend(dat,rend,col,imgfile);
    return
end
...
%==========================================================================
function surf_rend(dat,rend,col,imgfile)
...
H = spm_mesh_render_my('Disp',rend,struct('parent',ax));
spm_mesh_render_my('Overlay',H,imgfile,col);
spm_mesh_render_my('ColourBar',H,'on');

[do_I_take_snapshot, snapshot_label] = getRenderingSnapshot;

if do_I_take_snapshot
   
    spm_mesh_render_my('Snapshot',H,snapshot_label);
