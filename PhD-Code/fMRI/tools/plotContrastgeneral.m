function plotContrastgeneral(mu_z,label,plotParcelsLabels_idx,ROI)

doThePlot(mu_z,label,plotParcelsLabels_idx,ROI);

end

function doThePlot(mu_z,label,plotParcelsLabels_idx,ROI)
