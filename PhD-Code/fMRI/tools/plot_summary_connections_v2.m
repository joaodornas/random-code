...
% % %                             plot([x_up x_down],[y_up y_down],'k','LineWidth',FC_strength(position_hubs)*FC_width);
% % %                             hold on
% % %                         end
% % % 
...
% %%                               fill([x_patch_start_l x_patch_end_l x_patch_end_r x_patch_start_r],[y_patch_start_u y_patch_end_d y_patch_end_dd y_patch_start_uu],color(idx_all_NETs(i),:),'EdgeColor','none');
                ...
                print(f,'-depsc',strcat('Kiwis-',contrast_label{1},'-',direction_label{1},'-',parcellation_label{1},'.eps'));
