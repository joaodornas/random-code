function seeds = getFunctionalSeeds_v6(network_label)

%%% coordinates in mm

%%% CHANGES from v5 to v6
% added MT seeds from DAN to VIS
...
elseif strcmp(network_label,'VAN') %%% 200
    ...
    seeds.ROI(9).label = 'l-SFG'; %% It should be l-STG (superior temporal gyrus)
    seeds.ROI(9).x = -62.0;
    seeds.ROI(9).y = -50.0;
    seeds.ROI(9).z = 17.0;
    seeds.ROI(9).idx = 209;
...
elseif strcmp(network_label,'VIS') %%% 400
    ...
    seeds.ROI(13).label = 'r-MT-1';
    seeds.ROI(13).x = 42.4;
    seeds.ROI(13).y = -69.7;
    seeds.ROI(13).z = -11.2;
    seeds.ROI(13).idx = 120;
    
    seeds.ROI(14).label = 'r-MT-2';
    seeds.ROI(14).x = 51.0;
    seeds.ROI(14).y = -63.0;
    seeds.ROI(14).z = -14.0;
    seeds.ROI(14).idx = 121;
    
    seeds.ROI(15).label = 'l-MT-1';
    seeds.ROI(15).x = -43.4;
    seeds.ROI(15).y = -71.9;
    seeds.ROI(15).z = -7.7;
    seeds.ROI(15).idx = 122;
    
    seeds.ROI(16).label = 'l-MT-2';
    seeds.ROI(16).x = -46.0;
    seeds.ROI(16).y = -66.0;
    seeds.ROI(16).z = -15.0;
    seeds.ROI(16).idx = 123;
    
    seeds.ROI(17).label = 'l-MT-3';
    seeds.ROI(17).x = -47.0;
    seeds.ROI(17).y = -68.0;
    seeds.ROI(17).z = -14.0;
    seeds.ROI(17).idx = 124;
...
elseif strcmp(network_label,'LAN') %%% 600
    ...
    seeds.ROI(6).label = 'l-pIPS';
    seeds.ROI(6).x = -21.0;
    seeds.ROI(6).y = -76.0;
    seeds.ROI(6).z = 36.0;
    seeds.ROI(6).idx = 606;
    
    seeds.ROI(7).label = 'r-pIPS';
    seeds.ROI(7).x = 21.0;
    seeds.ROI(7).y = -77.0;
    seeds.ROI(7).z = 40.0;
    seeds.ROI(7).idx = 607;
    
    seeds.ROI(8).label = 'l-SPL-1';
    seeds.ROI(8).x = -16.0;
    seeds.ROI(8).y = -55.0;
    seeds.ROI(8).z = 61.0;
    seeds.ROI(8).idx = 608;
    
    seeds.ROI(9).label = 'l-SPL-2';
    seeds.ROI(9).x = -27.0;
    seeds.ROI(9).y = -57.0;
    seeds.ROI(9).z = 57.0;
    seeds.ROI(9).idx = 609;
    
    seeds.ROI(10).label = 'r-SPL';
    seeds.ROI(10).x = 24.0;
    seeds.ROI(10).y = -60.0;
    seeds.ROI(10).z = 64.0;
...
elseif strcmp(network_label,'DMN') %%% 800
    ...
    seeds.ROI(18).label = 'r-mPFC-2';
    seeds.ROI(18).x = 2.0;
    seeds.ROI(18).y = 53.0;
    seeds.ROI(18).z = 13.0;
    seeds.ROI(18).idx = 818;
    
    seeds.ROI(19).label = 'l-PCC-3';
    seeds.ROI(19).x = -3.0;
    seeds.ROI(19).y = -47.0;
    seeds.ROI(19).z = 29.0;
    seeds.ROI(19).idx = 819;
    
    seeds.ROI(20).label = 'l-PCC-4';
    seeds.ROI(20).x = -44.0;
    seeds.ROI(20).y = -66.0;
    seeds.ROI(20).z = 35.0;
    seeds.ROI(20).idx = 820;
    
    seeds.ROI(21).label = 'l-PCC-5';
    seeds.ROI(21).x = -11.0;
    seeds.ROI(21).y = -52.0;
    seeds.ROI(21).z = 38.0;
    seeds.ROI(21).idx = 821;
    
    seeds.ROI(22).label = 'r-AG-4';
    seeds.ROI(22).x = 43.0;
    seeds.ROI(22).y = -66.0;
    seeds.ROI(22).z = 43.0;
    seeds.ROI(22).idx = 822;
    
    seeds.ROI(23).label = 'l-AG-4';
    seeds.ROI(23).x = -33.0;
    seeds.ROI(23).y = -80.0;
    seeds.ROI(23).z = 38.0;
    seeds.ROI(23).idx = 823;
    
    seeds.ROI(24).label = 'l-AG-5';
    seeds.ROI(24).x = -46.0;
    seeds.ROI(24).y = -71.0;
    seeds.ROI(24).z = 27.0;
    seeds.ROI(24).idx = 824;
    
    seeds.ROI(25).label = 'l-AG-latIPS';
    seeds.ROI(25).x = -34.0;
    seeds.ROI(25).y = -74.0;
    seeds.ROI(25).z = 45.0;
    seeds.ROI(25).idx = 825;
    
    seeds.ROI(26).label = 'l-PCC-6';
    seeds.ROI(26).x = -3.0;
    seeds.ROI(26).y = -65.0;
    seeds.ROI(26).z = 29.0;
    seeds.ROI(26).idx = 826;
    
    seeds.ROI(27).label = 'l-PCC-7';
    seeds.ROI(27).x = -10.0;
    seeds.ROI(27).y = -52.0;
    seeds.ROI(27).z = 32.0;
    seeds.ROI(27).idx = 827;
    
    seeds.ROI(28).label = 'r-PCC';
    seeds.ROI(28).x = 11.0;
    seeds.ROI(28).y = -66.0;
    seeds.ROI(28).z = 25.0;
    seeds.ROI(28).idx = 828;
    
    seeds.ROI(29).label = 'l-PreCu';
    seeds.ROI(29).x = -2.0;
    seeds.ROI(29).y = -81.0;
    seeds.ROI(29).z = 52.0;
    seeds.ROI(29).idx = 829;
    
    seeds.ROI(30).label = 'l-AG-6';
    seeds.ROI(30).x = -43.0;
    seeds.ROI(30).y = -70.0;
    seeds.ROI(30).z = 32.0;
    seeds.ROI(30).idx = 830;
    
    seeds.ROI(31).label = 'r-AG-5';
    seeds.ROI(31).x = 47.0;
    seeds.ROI(31).y = -62.0;
    seeds.ROI(31).z = 25.0;
    seeds.ROI(31).idx = 831;
    
    seeds.ROI(32).label = 'r-AG-6';
    seeds.ROI(32).x = 43.0;
    seeds.ROI(32).y = -66.0;
    seeds.ROI(32).z = 43.0;
    seeds.ROI(32).idx = 832;
