function [IdxClusters, Tidx, Ncluster] = ClusterWithKmeans( rho_input, pval_input, nClusters )
...
%% compute the clusters
    ...
    [Tidx,C,sumd,D] = kmeans(rho_input, nClusters , 'distance', 'correlation', 'display', 'off','replicate',20);
