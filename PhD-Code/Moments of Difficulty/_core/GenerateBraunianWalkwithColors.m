%function [xi, yi, BallColors]= GenerateBraunianWalkwithColors(ItemsN, Settings, PresentationDuration_Sec, Oversample, FrameDuration)

function [xi, yi, vi, vixx, viyy, ai, oi, BallColors]= GenerateBraunianWalkwithColors
...
%% items moving randomly in square field, constantly changing their relative positions
  ...
  ObserverName = input('Please give the Settings file name:', 's');
...
%   figure;
%   hold on;
%   plot( xi(:,1), yi(:,1), 'ro', 'MarkerSize', 10 );
%   quiver( xi(:,1), yi(:,1), dvx, dvy,'r', 'LineWidth', 2 ); 
%   plot( Settings.MOT.Area.Size(1).*[-0.5 0.5 0.5 -0.5 -0.5], Settings.MOT.Area.Size(2).*[-0.5 -0.5 0.5 0.5 -0.5], 'k', 'LineWidth', 2 );
%   plot( (Settings.MOT.Area.Size(1)-2.*Settings.MOT.RepulsionRadius)*[-0.5 0.5 0.5 -0.5 -0.5], (Settings.MOT.Area.Size(2)-2.*Settings.MOT.RepulsionRadius)*[-0.5 -0.5 0.5 0.5 -0.5], 'k:', 'LineWidth', 2 );
%   hold off;
%   axis 'equal';    
