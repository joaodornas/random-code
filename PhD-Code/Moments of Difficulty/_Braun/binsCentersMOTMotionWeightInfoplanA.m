...
for iVelocity=velocities
    ...
    for i=1:length(idx_uniques_VMmin)
        ...
        datafile = load(strcat(prefix,int2str(iVelocity),'-',int2str(idx_uniques_VMmin(i)),'.mat'));
    ...
    for i=1:length(idx_uniques_VMmax)
        ...
        datafile = load(strcat(prefix,int2str(iVelocity),'-',int2str(idx_uniques_VMmax(i)),'.mat'));
    ...
    for i=1:length(idx_uniques_VM)
        ...
        datafile = load(strcat(prefix,int2str(iVelocity),'-',int2str(idx_uniques_VM(i)),'.mat'));
    ...
    save(strcat('infoBinsCentersMOTMotionWeight-',int2str(iVelocity),'.mat'),'info');
