...
uniques = load('uniqueKEminArea.mat');
...
for iMOTAnalyzeArea=1:length(idx_unique_areas)
    ...
    dataset = load(strcat(prefixAnalyzeArea,int2str(idx_unique_areas(iMOTAnalyzeArea)),'.mat'));
...
save('infoBinsCentersMOTArea.mat','info');
