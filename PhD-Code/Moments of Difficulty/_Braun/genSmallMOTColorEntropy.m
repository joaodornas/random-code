...
binsData = load('infoBinsCentersMOTColorEntropy.mat');

centers = binsData.info.centers;

prefixMOT = 'MOT-10-m-';
newprefixMOT = 'MOT-10-s-ColorEntropy-';
...
for nC=1:nCenters
    ...
    for kMOT=1:nMOT
        ...
        MOT.Entropies = analysis.Ecolor(frameBeforeInKs:frameAfterInKs);
        
        clear analysis
        
        MOT.MomentOfDifficulty = 'Color - Entropy';
