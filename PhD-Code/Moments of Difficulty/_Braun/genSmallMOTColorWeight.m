...
binsData = load('infoBinsCentersMOTColorWeight.mat');

centers = binsData.info.centers;

prefixMOT = 'MOT-10-m-';
newprefixMOT = 'MOT-10-s-ColorWeight-';
...
for nC=1:nCenters
    ...
    for kMOT=1:nMOT
        ...
        MOT.Weights = analysis.Wcolor(MOT.MainTarget,frameBeforeInKs:frameAfterInKs);
        
        clear analysis
        
        MOT.MomentOfDifficulty = 'Color - Weight';
