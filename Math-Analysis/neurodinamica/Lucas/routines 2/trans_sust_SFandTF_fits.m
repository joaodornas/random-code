...
for i=[1:4,6:12,14:ncells]
    ...
    for j=1:numel(lat)
        ...
        sf_responses_800(j)=mean(SF_psths(j,baseline_duration+1050:baseline_duration+1150));
    end
    ...
    for j=1:numel(lat)
        ...
        tf_responses_800(j)=mean(TF_psths(j,baseline_duration+1050:baseline_duration+1150));
    end
...
pref_SF_tillTau(find(rsquare_SF_tillTau<0.7))=nan; sigma_SF_tillTau(find(rsquare_SF_tillTau<0.7))=nan;
pref_SF_afterTau(find(rsquare_SF_afterTau<0.7))=nan; sigma_SF_afterTau(find(rsquare_SF_afterTau<0.7))=nan;
pref_SF_200(find(rsquare_SF_200<0.7))=nan; sigma_SF_200(find(rsquare_SF_200<0.7))=nan;
pref_SF_800(find(rsquare_SF_800<0.7))=nan; sigma_SF_800(find(rsquare_SF_800<0.7))=nan;
pref_TF_tillTau(find(rsquare_TF_tillTau<0.7))=nan; sigma_TF_tillTau(find(rsquare_TF_tillTau<0.7))=nan;
pref_TF_afterTau(find(rsquare_TF_afterTau<0.7))=nan; sigma_TF_afterTau(find(rsquare_TF_afterTau<0.7))=nan;
pref_TF_200(find(rsquare_TF_200<0.7))=nan; sigma_TF_200(find(rsquare_TF_200<0.7))=nan;
pref_TF_800(find(rsquare_TF_800<0.7))=nan; sigma_TF_800(find(rsquare_TF_800<0.7))=nan;

[r_prefSF_tau,p_prefSF_tau]=corr(pref_SF_tillTau_octv,pref_SF_afterTau_octv,'rows','pairwise','type','spearman')
[r_sigmaSF_tau,p_sigmaSF_tau]=corr(sigma_SF_tillTau,sigma_SF_afterTau,'rows','pairwise','type','spearman')
[r_prefSF_fixed,p_prefSF_fixed]=corr(pref_SF_200,pref_SF_800,'rows','pairwise','type','spearman')
[r_sigmaSF_fixed,p_sigmaSF_fixed]=corr(sigma_SF_200,sigma_SF_800,'rows','pairwise','type','spearman')
[r_prefTF_tau,p_prefTF_tau]=corr(pref_TF_tillTau,pref_TF_afterTau,'rows','pairwise','type','spearman')
[r_sigmaTF_tau,p_sigmaTF_tau]=corr(sigma_TF_tillTau,sigma_TF_afterTau,'rows','pairwise','type','spearman')
[r_prefTF_fixed,p_prefTF_fixed]=corr(pref_TF_200,pref_TF_800,'rows','pairwise','type','spearman')
[r_sigmaTF_fixed,p_sigmaTF_fixed]=corr(sigma_TF_200,sigma_TF_800,'rows','pairwise','type','spearman')