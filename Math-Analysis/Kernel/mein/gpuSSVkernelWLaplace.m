function [y,t,optw,gs,C,confb95,yb] = gpuSSVkernelWLaplace(x,tin)
...
%WinFunc = 1; %Window function ('Boxcar','Laplace','Cauchy','Gauss') 
WinFunc = 2; %Window function ('Boxcar','Laplace','Cauchy','Gauss')
%WinFunc = 3; %Window function ('Boxcar','Laplace','Cauchy','Gauss')
