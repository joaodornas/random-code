...
if strcmp(direction,'across_bins')
    ...
    print(g,'-depsc',strcat('/Volumes/Data/DATA/Forward-Backward/Power-Law/Fano-Factor/FF-DTC-Fractal/',name,'-FF-Fractal_across_bins-',trials,'.eps'));
    
    logFano = struct('name',name,'logFanoBins',logFanoBins,'coeff',coeff);
    
    save(strcat('/Volumes/Data/DATA/Forward-Backward/Power-Law/Fano-Factor/FF-DTC-Fractal/',name,'-FF-Fractal_across_bins-',trials,'.mat'),'logFano');
...
elseif strcmp(direction,'across_trials')
    ...
    plot(X,Y,'r');
    text(0.8*X,0.8*Y,num2str(coeff(2)),'FontSize',20);
    print(g,'-depsc',strcat('/Volumes/Data/DATA/Forward-Backward/Power-Law/Fano-Factor/FF-DTC-Fractal/',name,'-FF-Fractal_across_trials-',trials,'.eps'));
    
    logFano = struct('name',name,'logFanoTrials',logFanoTrials,'coeff',coeff);
    
    save(strcat('/Volumes/Data/DATA/Forward-Backward/Power-Law/Fano-Factor/FF-DTC-Fractal/',name,'-FF-Fractal_across_trials-',trials,'.mat'),'logFano');
